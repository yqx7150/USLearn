...
class US_pattern:
    ...
    def generate_US_pattern_1D(self, size_2D, R, no_of_training_profs = 15):
        ...
        if R==1:
            ...
            misc.imsave('uspat_np_r1.jpg',samp_patt)   # wsy add
            return samp_patt 
        ...
        if R==2:
            misc.imsave('uspat_np_r2.jpg',samp_patt)   # wsy add
        if R==3:
            misc.imsave('uspat_np_r3.jpg',samp_patt)   # wsy add
        if R==4:
            misc.imsave('uspat_np_r4.jpg',samp_patt)   # wsy add
        if R==5:
            misc.imsave('uspat_np_r5.jpg',samp_patt)   # wsy add
        return samp_patt
